...
export type UpdateChatroomMutation = { __typename?: 'Mutation', updateChatroom?: { __typename?: 'UpdateChatroomPayload', chatroom: { __typename?: 'Chatroom', id: string, label: string, description?: string | null, callerPhoneNumber: string, resolved: boolean, natureCode?: { __typename?: 'NatureCode', id: string, name: string } | null } } | null };
...
export const UpdateChatroomDocument = gql`
    mutation UpdateChatroom($id: ID!, $description: String, $resolved: Boolean) {
  updateChatroom(input: {id: $id, description: $description, resolved: $resolved}) {
    chatroom {
      ...ChatroomData
    }
  }
